...
from . import backup_targets, heartbeat, runtime, scheduler, tasks
...
for r in (auth.router, admin.router, backup_targets.router, users.router, extras.router, guests.router, nodes.router, pools.router, system.router):
